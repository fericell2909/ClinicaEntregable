...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="col-md-4">
                    <a href="{{url('/analysis/customers')}}">
                        <div id="customers">
                            ...
                            <h3><small style="color:#fff;">@lang('analysis.cusotmers')</small></h3>
                        </div>  <!-- end div #customer -->
                    </a>
                </div>
            </div> <!-- end div #analysis -->
            <div class="col-md-12" style="margin-top: 5px;"  id="analysis">
                <div class="col-md-4"><a href="{{url('analysis/reportes/medicas')}}"><div id="purchases"><i class="fa fa-users fa-5x"></i><h3 style="margin-top: 0px;"><small style="color:#fff;">Consultas Medicas</small></h3></div></a>
                </div>
            ...
            <div class="col-md-12" style="margin-top: 5px;"  id="analysis">
                <div class="col-md-4"><a href="{{url('analysis/reportes/stockmedicamentos')}}"><div id="purchases"><i class="fa fa-list fa-5x"></i><h3 style="margin-top: 0px;"><small style="color:#fff;">Reporte Stock de Medicamentos</small></h3></div></a>
                </div>
