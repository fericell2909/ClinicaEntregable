...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Venta de Medicamentos por Usuario</title>
    <body>
 ...
 <table cellspacing="0" style="width: 100%;border-bottom: 1px solid #000;">
    ...
    <br>
  	<p style="font-size:14px;font-weight:bold;text-align:center;display: block; margin-left: auto;margin-right: auto;"><span style="background: #2c3e50;color:#fff;padding: 10px;">REPORTE DE VENTA DE MEDICAMENTOS POR USUARIO</span></p>	
    <br>    
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;border:1px solid #000;">
        ...
        @if(count($ventas) > 0)
            ...
            @endforeach  
            <tr>
                <td colspan="2" style="text-align: right;border-left: 1px solid #fff;border-bottom: 1px solid #fff; border-right: 1px solid #fff;">Total de Medicamentos Vendidos en el día : </td>
        ...
        @else
            <tr>
                <td colspan="3"  style="text-align: center;""> El Usuario : {{$usuarios[0]->name}} con correo : {{$usuarios[0]->email}} no ha registrado venta de medicamentos en el dia : {{$fechaventadocumento}} </td>
            </tr>
        @endif
