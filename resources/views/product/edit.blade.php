...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading"><h3 class="text-center text-info">@lang('products.edittitle') {{$product->p_gname}}</h3></div>
        <div class="panel-body">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::text('quantity', $product->p_quantity, ['class' => 'form-control', 'placeholder' => trans('products.quantity'),'readonly' =>'readonly'])}}
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    {{Form::label('orgprice',trans('products.dtype'), ['class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
