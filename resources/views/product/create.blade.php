...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="text-center text-info">@lang('products.newtitle')</h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::text('imdate', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control', 'data-date-format' => 'yyyy-mm-dd'])}}
                    </div>
                </div>
                <div class="form-group">
                    {{Form::label('exdate',trans('products.exdate'), ['class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                        {{Form::text('exdate', \Carbon\Carbon::now()->format("Y-n-j"), ['class' => 'datepicker form-control' , 'data-date-format' => 'yyyy-mm-dd'])}}
                    </div>
                </div>
                <div class="form-group">
