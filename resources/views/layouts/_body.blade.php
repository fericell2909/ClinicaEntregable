@if (Auth::user())
    <div class="container-fluid">
        <div class="col-md-1 col-sm-1 hidden-xs" id="sideNavbar">
                ...
                <div class="navbar navbar-inverse navbar-fixed-left">
                    ...
                    <ul class="nav navbar-nav"  style ="margin-top: 5px;">
                        ...
                        <li class="dropup" title="Medicos" data-toggle="tooltip">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{route('RegistrarHistoriaClinica')}}"><i class="fa  fa-file-text fa fa-2x"
                                                                            aria-hidden="true"></i>
                                        <p>Registrar Historia Clínica</p></a></li>

                                <li><a href="{{route('ListarPacientes')}}"><i class="fa  fa-file-text fa fa-2x"
                                                                            aria-hidden="true"></i>
                                        <p>Pacientes</p></a></li>
                                        
                                <li><a href="{{route('ListarHistoriaClinicaxPaciente')}}"><i class="fa  fa-list fa fa-2x"
                                                                            aria-hidden="true"></i>
                        ...
                        <li class="dropup" id="settingNav" title="@lang('navbar.setting')" data-toggle="tooltip">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{url('/setting/series')}}"><i
                                        class="fa fa-file-text-o fa fa-2x" aria-hidden="true"></i>
                                    <p>  @lang('navbar.series')</p></a></li>
            ...
            @endif
            @if(Auth::user()->hasAnyRole(['Medico(a)']))
                <div class="navbar navbar-inverse navbar-fixed-left">
