        ...
        <ul class="nav navbar-nav navbar-right nav-menu-phone hidden-lg hidden-md hidden-lg hidden-md hidden-lg hidden-md hidden-sm">
            ...
            <li class="dropdown" id="settingNav">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class=""><a href="{{url('/setting/series')}}"><i
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="{{ set_active(['product', '/prodcut/expired']) }}"><a
                                    href="{{ url('/product/expired') }}"><i class="fa fa-exclamation-circle fa-2x"
                                                                            aria-hidden="true"></i>
                                <p> @lang('navbar.expired')</p><span id="notif-circle"><p>{{expiredCount()}}</p></span>
                            </a></li>
                    </ul>
            </li>
            @endif
            @if(Auth::user()->hasAnyRole(['farmacia']))
                <li class="{{ set_active(['/', '/*']) }}"><a href="{{url('/')}}" title=" @lang('navbar.dashboard')"
                                        ...
                                        class="fa fa-tachometer fa fa-2x " aria-hidden="true"></i><p class="hidden-lg hidden-md hidden-sm">  @lang('navbar.dashboard')</p></a></li></a></li>
