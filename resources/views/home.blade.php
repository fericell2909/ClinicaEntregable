...
@section('content')
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading"><span class="text-success">@lang('dashboard.dashboard')</span></div>
                    ...
                    <div class="col-md-6 col-sm-6  col-xs-12">
                        <div id="totalSale">
                            <div id="pContent">
                                <h3>
                                    @if(!empty($totalsale))
                                       S/. {{$daySales['today'] }} {{-- {{floatval($totalsale[0]->totalsale)}} --}}
                                    @else
                                        S/. {{number_format($daySales['today'],2) }}
                                    @endif
                                </h3>
                                <hr>
                                <p>
                                    {{check($daySales['yasterday'],$daySales['today'])}}
                                    Ventas del Dia </p> {{-- @lang('dashboard.totalsales') --}}
                            </div>  <!-- end div #pContent -->
                            ...
                            <div id="pContent">
                                <h3>
                                    @if(!empty($totalpurchases))
                                        {{$totalpurchases[0]->totalpurchases}} S/.
                                    @else
                                        0 S/.
                                    @endif
                                </h3>
    ...
    <div class="col-md-8 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading"><span class="text-info">@lang('dashboard.analysis')</span></div>
            <div class="panel-body">
    ...
    <div class="col-md-4 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading"><span class="text-info">@lang('dashboard.analysisTop')</span></div>
            <div class="panel-body">
                <div class="col-md-12 col-sm-12 col-xs-12 pull-right">
    ...
    <div class="col-md-8 col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading"><span class="text-info">@lang('dashboard.lastcustomer')</span></div>
            <div class="panel-body">
